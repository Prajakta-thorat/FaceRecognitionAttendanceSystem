...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "facerec-e27d4.appspot.com"
})
        ...
        if counter != 0:
            if counter == 1:
                try:
                    ...
                    if blob:
                        ...
                        print("Error: Image not found or unable to retrieve blob from Firebase storage")
                        # Handle the case when the blob is not found or retrieval fails
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo.get('id', 'N/A')), (1006, 493),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
